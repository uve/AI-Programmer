...
namespace AIProgrammer
{
    ...
    class Program
    {
        ...
        private static int _genomeSize = 1000; // Number of programming instructions in generated program (size of genome array). loops).
        private static int _maxGenomeSize = 1500; // The max length a genome may grow to (only applicable if _expandAmount > 0).
